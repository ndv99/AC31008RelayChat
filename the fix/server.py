...
class Server:
    ...
    def start_server(self):
        ...
        self.memory.socket.bind((self.memory.ipv4_address, self.memory.port)) # Bind a socket to a given IP and port

        print(f"'{self.memory.server_name}' is now running on {self.memory.ipv4_address}:{self.memory.port}.")
